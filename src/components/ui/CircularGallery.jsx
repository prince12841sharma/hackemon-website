...
function createTextTexture(gl, text, font = "bold 5px monospace", color = "black") {
...
export default function CircularGallery({
  ...
  return (
    <div className='w-full h-full font-bold overflow-hidden cursor-grab active:cursor-grabbing' ref={containerRef} />
  )
}
